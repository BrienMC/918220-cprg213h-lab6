...
function changeModel() {
    ...
    var textModel = document.getElementById("model-text");
...
function changeDuration() {
    ...
    var textDuration = document.getElementById("duration-text");

    duration = prompt("Please enter how many days you would like to rent a robot for:");
